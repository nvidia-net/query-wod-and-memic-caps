...
enum
{
    MLX5_HCA_CAP_OP_MOD_GET_MAX = 0,
    MLX5_HCA_CAP_OP_MOD_GET_CUR = 1,
};

enum
{
    MLX5_SET_HCA_CAP_OP_MOD_GENERAL_DEVICE = 0x0 << 1,
    MLX5_SET_HCA_CAP_OP_MOD_ATOMIC = 0x3 << 1,
};
...
enum
{
    ...
    MLX5_FIELD_SELECT_802_1QAU_RP_FIELD_SELECT_8021QAURP_RPG_MIN_DEC_FAC =
        0x400,
